...
var ASM_CONSTS = {
  4612488: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4612543: ($0) => { performance.now = function() { return $0; }; },  
 4612591: ($0) => { performance.now = function() { return $0; }; },  
 4612639: () => { performance.now = Module['emscripten_get_now_backup']; }
};
